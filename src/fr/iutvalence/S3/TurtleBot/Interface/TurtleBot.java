...
public class TurtleBot {
	...
	private void initialize() {
		...
		thumb.setIcon(new ImageIcon(TurtleBot.class.getResource("/fr/iutvalence/S3/TurtleBot/Ic\u00F4nes/Sans titre-3.png")));
		panel.add(thumb);
		panel_4.add(panel);
		
		//bouton carte
		JButton btnNewButton_2 = new JButton("\r\n");
		btnNewButton_2.setIcon(new ImageIcon(TurtleBot.class.getResource("/fr/iutvalence/S3/TurtleBot/Ic\u00F4nes/Sans titre-2.png")));
